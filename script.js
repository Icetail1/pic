  ...
  if (input.files && input.files[0]) {
    ...
    reader.onload = function (e) {
      ...
      recognizeText(imageSrc, function (text) {
        ...
        var result = cleanText.includes("王") ? "粉丝群794117143，密码是这个题答案：ICE的司机每天早上7点30分到家接他去公司上班，有一天ICE早上7点从家出发步行去公司，路上遇到按时来接他的车，乘车去公司，结果早到5分钟。请问汽车速度是ICE步行速度的几倍？" : "识别错误，请检查你的截图是否跟例图大小一致/有没有佩戴我的粉丝牌/截图的页面、内容是否和例图一致";
        ...
        if( cleanText.includes("Icetail_official"))
        {
          ...
          // 输出结果
        resultDiv.innerHTML = "<p>" + result  + cleanText +"</p>";
