  ...
  if (input.files && input.files[0]) {
    ...
    reader.onload = function (e) {
      ...
      recognizeText(imageSrc, function (text) {
        ...
        var result = cleanText.includes("猫咪王") ? "粉丝群794117143，密码是这个题答案：Ice小学共有450人，喜欢外语与不喜欢外语的人数的比为5：4,喜欢数学和不喜欢数学的人数的比为8:7,两门都喜欢的有100人，问两门都不喜欢的有多少人？" : "识别错误，请检查你的截图是否跟例图大小一致/有没有佩戴我的粉丝牌/不行就只截图你的名字和粉丝牌然后放大再传";
